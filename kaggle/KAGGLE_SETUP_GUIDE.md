...
[Step 4] Isochrony-Aware Translation  ★ v2.5 core ★
         Hybrid routing → 3 candidates/segment:
           • Bulk iteration-0 batch on lenient Gemma (gemma-4-31b-it / gemma-4-26b-a4b-it)
...
iteration-0 batch runs on the more lenient Gemma models** (`gemma-4-31b-it` → `gemma-4-26b-a4b-it`) and
...
|---|---|---|
| `DUBBING_GEMINI_BULK_MODEL` | `gemma-4-31b-it` | Model for the high-volume first pass. |
